...
class Setting extends CI_Controller
{
    ...
    public function upload_avatar()
    {
        ...
        $this->template->load('template', 'admin/setting_upload_avatar.php', $data);
    }
    ...
    public function edit_profile()
    {
        ...
        if ($this->input->method() === 'post') {
            ...
            if ($this->form_validation->run() === FALSE) {
                return $this->template->load('template', 'admin/setting_edit_profile_form.php', $data);
            }
        ...
        $this->template->load('template', 'admin/setting_edit_profile_form.php', $data);
    }
    ...
    public function edit_password()
    {
        ...
        if ($this->input->method() === 'post') {
            ...
            if ($this->form_validation->run() === FALSE) {
                return $this->template->load('template', 'admin/setting_edit_password_form.php', $data);
            }
        ...
        $this->template->load('template', 'admin/setting_edit_password_form.php', $data);
    }
}
